   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="method">
               <option value="cash on delivery">Thanh toán tiền mặt khi giao hàng</option>
         ...
         <div class="inputBox">
            <span>Dòng địa chỉ 1 :</span>
            <input type="number" min="0" name="flat" required placeholder="Vd: Số nhà, Số căn hộ...">
         </div>
         <div class="inputBox">
            <span>Dòng địa chỉ 2 :</span>
            <input type="text" name="street" required placeholder="Vd: Tên đường...">
         </div>
         <div class="inputBox">
            <span>Thành phố :</span>
